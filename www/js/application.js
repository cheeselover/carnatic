(function() {
  angular.module('carnatic', ['ionic', 'firebase', 'carnatic.controllers', 'carnatic.factories', 'carnatic.models', 'carnatic.directives']).run([
    '$ionicPlatform', '$rootScope', 'Auth', function($ionicPlatform, $rootScope, Auth) {
      ...
      return $rootScope.$on('$stateChangeStart', function(event, toState) {
        if (toState.name.substring(0, 3) === 'app') {
    ...
    '$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
      ...
      return $urlRouterProvider.otherwise('/app/compose');
    }
...
(function() {
  angular.module('carnatic.controllers').controller("AccountCtrl", [
    '$scope', 'userProfile', function($scope, userProfile) {
      return $scope.userProfile = userProfile;
    }
  ]);
...
(function() {
  angular.module('carnatic.controllers').controller("ComposeCtrl", [
    '$scope', 'KorvaiHelper', 'korvais', function($scope, KorvaiHelper, korvais) {
  ...
  angular.module('carnatic.factories').factory("KorvaiHelper", function() {
    return {
      ...
      repeatString: function(r) {
        var e, j, lastColon, numOfRepeats, rString, repeaters, _i, _len;
...
(function() {
  angular.module('carnatic.models').factory("Followers", function($firebase, REF) {
    return function(userId) {
      return $firebase(REF.child('followers').child(userId)).$asObject();
    };
  }).factory("Followings", function($firebase, REF) {
    return function(userId) {
      return $firebase(REF.child('followings').child(userId)).$asObject();
    };
  });
...
(function() {
  angular.module('carnatic.models').factory("KorvaiList", function($firebase, REF) {
    return function(userId) {
      return $firebase(REF.child('korvais').child(userId)).$asArray();
    };
  });
...
(function() {
  angular.module('carnatic.models').factory("UserProfile", function($firebase, REF) {
    return function(userId) {
...
(function() {
  angular.module('carnatic.models').factory("User", [
    '$firebase', 'KorvaiList', 'UserProfile', 'Followings', 'Followers', function($firebase, KorvaiList, UserProfile, Followings, Followers) {
      var User;
      return User = (function() {
        ...
        User.prototype.userProfile = function() {
          return new UserProfile(this.userId).$loaded();
        };
        ...
        User.prototype.followers = function() {
          return new Followers(this.userId).$loaded();
        };

        User.prototype.followings = function() {
          return new Followings(this.userId).$loaded();
        };
